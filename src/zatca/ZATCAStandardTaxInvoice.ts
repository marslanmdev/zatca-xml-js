...
import defaultStandardTaxInvoice, {
...
export { ZATCAStandardInvoiceLineItem, ZATCAStandardInvoiceProps, ZATCAInvoiceTypes, ZATCAPaymentMethods };
export class ZATCAStandardTaxInvoice {

    private invoice_xml: XMLDocument;

    /**
     * Parses a ZATCA Standard Tax Invoice XML string. Or creates a new one based on given props.
    ...
    constructor({ invoice_xml_str, props }: { invoice_xml_str?: string, props?: ZATCAStandardInvoiceProps }) {
        ...
        if (invoice_xml_str) {
            ...
            this.invoice_xml = new XMLDocument(defaultStandardTaxInvoice(props));
